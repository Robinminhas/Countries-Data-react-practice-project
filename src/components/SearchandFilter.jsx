...
export default function SearchandFilter({setQuery}) {
  return (
    <section className="flex items-center justify-between w-full h-20 mt-6">
      ...
      <div className="bg-slate-700 p-2 rounded-xl md:w-96 md:ml-9 flex items-center gap-2">
        <IoSearch />
        <input
          type="search"
          name=""
      ...
      <div className="md:mr-8 flex md:flex-row flex-col items-center md:gap-2 gap-0 shadow-2xl bg-slate-700 md:p-3">
